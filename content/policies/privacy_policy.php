...
?>
    ...
    <h2>Who we are</h2>
    <p>At Titan, accessible from https://project.lucande.io, one of our main priorities is the privacy of our visitors.
        This Privacy Policy document contains information collected and recorded by Titan and how we use it.</p>
    <p>If you have additional questions or require more information about our Privacy Policy, do not hesitate to contact
        us.</p>
    <p>This Privacy Policy applies only to our online activities and is valid for visitors to our website regarding the
        information that they shared and/or collect in Titan. This policy does not apply to any information collected
        offline or via channels other than this website.</p>
    <p>You may make an inquiry at this email: lucande@pm.me</p>
    <h2>Personal data we collect and why we collect it</h2>
    <h3>Entries</h3>
    <p>When visitors create or modify meal entries, we collect the data provided, and also the visitor’s IP address and
    ...
    <p>We do not run any advertisement campaigns, so your data is not shared with any third-party or advertisement company.</p>
    <h2>How long we retain your data</h2>
    <p>If you create a meal or food entry,, the data and its metadata are retained indefinitely unless deleted.</p>
    ...
    <p>Our services interact with Amazon Web Services.  Information is contained internally to this service.</p>
    ...
    <h2>Log Files</h2>
    <p>Titan follows a standard procedure of using log files. These files log visitors when they visit websites. All hosting
    companies do this and a part of hosting services’ analytics. The information collected by log files include internet
    protocol (IP) addresses, browser type, Internet Service Provider (ISP), date and time stamp, referring/exit pages, and
    possibly the number of clicks. These are not linked to any information that is personally identifiable. The purpose of
    ...
    <ul>
        ...
        <li>You also have the right to request that we complete the information you believe is incomplete.</li>
...
guardians to observe, participate in, and/or monitor and guide their online activity. Whilst we have no way of verifying
    this, we request that anyone who uses our services (i.e.) creating an account be over the age of 13.</p>
<p>Titan does not knowingly collect any Personal Identifiable Information from children under the age of 13. If you think
that your child provided this kind of information on our website, we strongly encourage you to contact us immediately,
    and we will do our best to remove such information from our records promptly.</p>
